...
namespace GenTools.Views.GachaViews
{
    public sealed partial class WeaponGachaView : Page
    {

        public WeaponGachaView()
        {
            this.InitializeComponent();
            Logging.Write("Switch to WeaponGachaView", 0);
            LoadData();
        }
        ...
        private async void LoadData()
        {
            ...
            var settingsFile = GenToolsFolder.GetFileAsync("GachaRecords_Weapon.ini").AsTask().GetAwaiter().GetResult();
